    ...
    <ul class="fr topTh">
       <li class="login" id="login">
      	<span id="loginbar" style="margin-right: 15px;">
	      	<a href="http://passport.e3mall.cn:8088/page/login?returnUrl=http%3A//www.e3mall.cn:8082/">请登录</a>
      	</span>
      	<a href="http://passport.e3mall.cn:8088/page/register/?returnUrl=http%3A//www.e3mall.cn:8082/">免费注册</a>
      </li>
